      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Our world faces unprecedented challenges that traditional systems are failing to address</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700">Corrupt leaders and systems siphon resources meant for public welfare, while ordinary citizens suffer from lack of basic necessities.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700">The gap between rich and poor widens as centralized banking systems and currency manipulation benefit the elite few.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700">Slow, outdated governmental processes and lack of transparency create barriers to progress and foster distrust.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform hover:-translate-y-2">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700">Central banks and financial institutions control monetary policies that lead to inflation, devaluation, and economic instability.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Artificial Intelligence is reshaping our world at unprecedented speed</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700">The choice we face is clear: allow AI to become a tool of further control and inequality, or proactively design AI systems that distribute power, increase transparency, and serve humanity's collective interests.</p>
            </div>
            <div className="bg-gray-200 h-80 rounded-lg"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-[#0C6E4E] text-white p-8 rounded-lg text-center">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">Our vision extends beyond a single community to transform societies worldwide</p>
          </div>
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Eliminating interest-based systems that perpetuate poverty and inequality</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Ending corruption through blockchain-verified transparent systems</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Providing access to quality, holistic education to all community members</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-100 p-8 rounded-lg">
              ...
              <div className="mb-4">
                ...
                <p className="font-mono bg-white p-2 rounded">0133-79543-01</p>
              </div>
              <div>
            ...
            <div className="bg-gray-100 p-8 rounded-lg">
              ...
              <div className="mb-4">
                ...
                <p className="font-mono bg-white p-2 rounded">03339214600</p>
              </div>
              <div className="mb-4">
            ...
            <div className="bg-gray-100 p-8 rounded-lg">
              ...
              <div className="mb-4">
                ...
                <p className="font-mono bg-white p-2 rounded text-sm">TAYc66GdUqufsWcAHXxS6qgXRW2w73179f</p>
              </div>
              <div className="mb-4">
                <p className="font-semibold mb-1">BNB:</p>
                <p className="font-mono bg-white p-2 rounded text-sm">0xd4f5912e37aa51402849acd7d9d4e7e9d94eb458</p>
              </div>
              <div>
                <p className="text-sm text-gray-600 mt-4">* For other cryptocurrency options, please contact us</p>
              </div>
            </div>
          </div>
