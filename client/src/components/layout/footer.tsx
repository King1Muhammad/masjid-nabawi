          ...
          <div className="mb-6 sm:mb-0">
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="flex items-start">
                ...
                <a href="https://maps.app.goo.gl/6s6MxCCFU8RXsBuE6" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#D4AF37] transition-colors text-sm">
