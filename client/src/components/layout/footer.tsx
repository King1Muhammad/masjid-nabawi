      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">A center for Islamic education, community service, and spiritual growth in Islamabad following the model of Masjid-e-Nabawi.</p>
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+923339214600" className="text-gray-400 hover:text-[#D4AF37] transition-colors">
                  +92 333 921 4600
                </a>
              </div>
              <div className="flex items-center">
                ...
                <a href="https://maps.app.goo.gl/6s6MxCCFU8RXsBuE6" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#D4AF37] transition-colors">
                  G11/4, Islamabad, Pakistan
                </a>
              </div>
            </div>
            
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=100057643823411" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#D4AF37] transition-colors">
